...
int* MakePearsonTable(int capacity = InitialSize)
{
...
void Add(HashTable* hashTable, const string& key, const string& value)
{
    ...
    hashTable->CurrentSize++;
    if (static_cast<float>(hashTable->CurrentSize) / hashTable->Capacity > factorial)
    {
        Rehash(hashTable);
    }
}
...
HashTable* CreateHashTable()
{
    ...
    hashTable->HashTable = new HashTableItem * [InitialSize];
